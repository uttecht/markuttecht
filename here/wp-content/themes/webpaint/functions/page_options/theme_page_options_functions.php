			...
			//Image
					case 'image':
						...
						echo '<span class="custom_default_image" style="display:none">'.$image_def.'</span><a href="#" class="custom_media_upload">Choose Image</a><br>
								...
								<input class="custom_media_id" type="hidden" name="'.$field['id'].'" value="'.$meta.'"><br clear="all" /><small>&nbsp;<a href="#" class="custom_clear_image_button">Remove Image</a></small><br><span class="description">'.$field['desc'].'</span></td>';
					break;
