...
function ST5_columns_head($defaults) {
 $defaults['tb_webpaint_category'] = 'Category';
 return $defaults;
}

function ST5_columns_content($column_name, $post_ID) {
  if ($column_name == 'tb_webpaint_category') {
...
function ST6_columns_head($defaults) {
 $defaults['tb_webpaint_gallery_category'] = 'Gallery';
 return $defaults;
}

function ST6_columns_content($column_name, $post_ID) {
  if ($column_name == 'tb_webpaint_gallery_category') {
